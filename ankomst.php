...
<div class= "checklista">
    ...
    <p> <b>Sätt i kontkaten till varmvattenberedaren:</b> Den finns i badrummet, till vänster om spegeln. </p>
    <p> <b>Sätt på kylskåpet:</b> Sätt i kontakterna. Det finns ett vrede som reglerar kylan i kylskåpet. </p>
    <p> <b>Sätt igång spisen:</b> Gasoltuben finns i skåpet till höger om spisen. Det finns en svart plastknapp på gasoltuben som du stänger av och på gasolen med. Obs! Om gasolen tar slut, byt ut den i järnhandeln. </P>
    <P> <b>AC: </b> Finns i båda sovrummen. De används endast nattetid. Rekomenderar 24-26 grader. </p>
