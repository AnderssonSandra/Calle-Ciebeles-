...
<?php 
$heroTitel = "Sevärdigheter";
$heroText = "Här har du lite tips på sevärdigheter runt om i krokarna!";
$heroBild = "Bilder/vattenfall.jpg";
include 'hero.php';
...
$sql = "SELECT * FROM tips WHERE kategori= 'sevärdighet'";
...
if ($result->num_rows > 0) {
    ...
    while ($row=$result->fetch_assoc()) {
        ...
        echo "<p><b> Datum: </b>" . date( "Y-m-d", strtotime ($row ["datum"]) ) . "</p>" ;
